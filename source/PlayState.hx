...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// "GLOBAL" SCRIPTS
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['hud', 'Ending', 'script2', 'script3', 'script4']; // I don't think I need to explain this 
		...
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['cutcene', 'Zoom Girlfriend', 'camFollow', 'Follow', 'script4']; // I don't think I need to explain this 
		for (script in daScripts) {
